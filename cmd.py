...
for i, data in enumerate(tqdm(avi_data)):
    ...
    string = "python v2e.py -i {}  --output_folder=output/ --dvs_h5 dvs{} --dvs_exposure duration 0.01 --overwrite --timestamp_resolution=0.01 --auto_timestamp_resolution=False --pos_thres=.15 --neg_thres=.15 --sigma_thres=0.03 --output_width=240 --output_height=180  --cutoff_hz=15 --disable_slomo --input_slowmotion_factor 1 --no_preview --label [{},{},{}]".format(data, str(i),str(x),str(y),str(z))
    _ = os.system(string)
